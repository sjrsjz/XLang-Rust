...
use super::{build_dict, check_if_tuple};
...
fn chdir(
    ...
    let new_dir = tuple_obj.values[0]
...
fn getenv(
    ...
    let var_name = tuple_obj.values[0]
        .as_const_type::<VMString>()
        .value
        .clone();
...
fn setenv(
    ...
    if !tuple_obj.values[0].isinstance::<VMString>()
        || !tuple_obj.values[1].isinstance::<VMString>()
    {
        return Err(VMVariableError::TypeError(
            args_tuple.clone_ref(),
    ...
    let var_name = tuple_obj.values[0]
        ...
        .value
        .clone();
    let var_value = tuple_obj.values[1]
        .as_const_type::<VMString>()
        .value
        .clone();
...
fn system(
    ...
    let command_str = tuple_obj.values[0]
        .as_const_type::<VMString>()
        .value
        .clone();
...
fn dirname(
    ...
    let path_str = tuple_obj.values[0]
        .as_const_type::<VMString>()
        .value
        .clone();
